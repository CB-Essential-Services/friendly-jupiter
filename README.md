...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/5ff5d146778aa7001596a8b5
...
To start editing your site, you can use the Sanity interface at https://friendly-jupiter-5d146.sanity.studio/.
...
Generated at `2021-01-06T15:06:14.459Z` by Stackbit version `0.3.42`.